 ...
 */
 public abstract class Element3D implements Serializable {
	...
	/**if element contains other elements*/
	protected boolean elementContainer = false;

	private ArrayList<Element3D> containedElements;
	...
	public ArrayList<Element3D> getContainedElements(){
		return new ArrayList<Element3D>();
	}
	
	public void setElementContainer(boolean elementContainer) {
